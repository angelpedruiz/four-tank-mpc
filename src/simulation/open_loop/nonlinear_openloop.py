'''
Simulation of the open-loop system for the non-linear model.
'''
import numpy as np
...
u_seq = create_piecewise_cnst_seq(num_inputs=2, total_time=T, dt=dt, min_val=0, max_val=10, step_resolution=0.5, number_of_steps=10)
...
fig.suptitle('Four Tank System - Nonlinear Model Open Loop Simulation', fontsize=16)
...
# Print final states
print(f"\nNonlinear Model Simulation completed!")
