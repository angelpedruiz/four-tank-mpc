...
def main():
    """Main function for running stochastic open-loop simulation with plotting."""
    ...
    # Initial conditions
    x0 = np.array([0, 0, 0, 0])  # initial mass in tanks [g]
    ...
    d_seq = piecewise_random(num_inputs=2, total_time=T, dt=dt, value_range=(0.0, 6.0), step_resolution=10, number_of_steps=5)

    # Piecewise constant input sequence (random steps)
    u_seq = piecewise_constant([[200, 200], [200, 200]], total_time=T, dt=dt)
